...
list1 = ["Яблоко","Груша", "Арбуз", "Банан"]
list2 = ["Персик", "Киви", "Банан", "Нектарин"]
...
list3 = [1,3,4,6,8,9,10,15,66,79,0,15,17,44,30,-3,-9,-4]
list4 = []
for i in list3:
     if i % 3 == 0:
        if i % 4 != 0:
...
upper = list(map(lambda x: chr(x), list(range(65,91)))) # Преобразуем список из кодов ANSI в список букв A-Z
line_new = list(line)
 
for i, element in enumerate(line_new[:]):
    for element_2 in upper:
