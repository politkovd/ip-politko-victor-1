...
def main():
    src = ''
    # path = '/Users/viktorpolitko/VSCODE/ip-politko-victor-1/Homework/hw6/Homework6.py'
    # os.getcwd
    if path.exists('/Users/viktorpolitko/VSCODE/ip-politko-victor-1/Homework/hw6/Homework6.py'):
        src = path.abspath("/Users/viktorpolitko/VSCODE/ip-politko-victor-1/Homework/hw6/Homework6.py")
