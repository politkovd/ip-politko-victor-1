...
if equation_list[0].isdigit():
    print('это первая дробь с целой частью!')
else:
    print('это первая дробь без целой части!')
 
if equation_list[-2].isdigit():
    print('это вторая дробь с целой частью!')
else:
    print('это вторая дробь без целой части!')
