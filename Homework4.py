...
print(equation_list[0].isdigit())
 
if equation_list[0].isdigit():
    print('енто первая дробь с целой частью!')
else:
    print('енто первая дробь без целой части!')
 
if equation_list[-2].isdigit():
    print('енто вторая дробь с целой частью!')
else:
    print('енто вторая дробь без целой части!')
